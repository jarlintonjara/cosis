...
<title>Sistema|Contabilidad de costos</title>
    ...
    <body>
        ...
        <div id="yw6"></div>
                    ...
                    <div id="breadcrumbs">
                            <ul class="breadcrumbs breadcrumb"><li><a href="<?php echo base_url();?>panel/index">Home</a><span class="divider">/</span></li><li class="active">Administración</li></ul><!-- breadcrumbs -->
                    </div>
